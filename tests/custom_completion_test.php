...
use mod_quizgame\completion\custom_completion;
...
/**
 * Class for unit testing mod_quizgame/activity_custom_completion.
 *
 * @package   mod_quizgame
 * @copyright 2021 Stephen Bourget
 * @copyright 2026 Adam Jenkins <hama.history@gmail.com>
...
final class custom_completion_test extends advanced_testcase {
    ...
    public function test_get_state(string $rule, int $available, int $highscorecount, ?int $status, ?string $exception): void {
        ...
        $DB->expects($this->atMost(2))
            ->method('count_records_select')
            ->willReturn($highscorecount);
    ...
    public function test_is_defined(): void {
        ...
        // Rule is defined.
        $this->assertTrue($customcompletion->is_defined('completionscore'));
